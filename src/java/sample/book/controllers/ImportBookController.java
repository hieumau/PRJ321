 ...
 * @author saost
 */
public class ImportBookController extends HttpServlet {
...
//    private static final String ERROR = ViewLibraryController.class.getSimpleName();
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        String url = SUCCESS;
        try {
            int amount = Integer.parseInt(request.getParameter("import"));
            String bookID = request.getParameter("id");
            BookDAO bookDAO = new BookDAO();

            bookDAO.importBook(Integer.parseInt(bookID), amount);
            request.setAttribute("SUCCESS_MESSAGE", "Import successful");
